...
const Footer = () => {
  return (
    <footer className="page-footer bg-secondary text-light center-on-small-only mt-4">
            ...
            <div className="col-md-12">
              <div className="mb-4 d-flex align-center">
                ...
                <a href="http://instagram.com" className="p-2">
                  <i className="fa fa-instagram fa-lg text-light mx-md-4"> </i>
                </a>

                <a href="http://pinterest.com" className="p-2">
                  <i className="fa fa-pinterest fa-lg text-light ml-md-4"> </i>
                </a>
              </div>
            </div>
          </div>
