...
const WeeklyLoss = ({ user, users, setUser, handleChange }) => {
        ...
        {!weight ? (
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <input
              ...
              name="weight_lbs"
              placeholder="lbs"
              defaultValue={user.net_weekly_weight_change_lbs}
              onChange={handleChange}
              ref={register({ required: true, maxLength: 3, max: 999 })}
            />
            {errors.net_weekly_weight_change_lbs && (
